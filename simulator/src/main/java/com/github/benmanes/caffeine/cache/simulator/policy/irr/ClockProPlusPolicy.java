...
public final class ClockProPlusPolicy implements KeyOnlyPolicy {
    ...
    public ClockProPlusPolicy(Config config) {
        ...
        minResColdSize = Math.max(settings.lowerBoundCold(), (int) (maxSize * settings.percentMinCold()));
        maxResColdSize = Math.min(maxSize - minResColdSize, (int) (maxSize * settings.percentMaxCold()));
