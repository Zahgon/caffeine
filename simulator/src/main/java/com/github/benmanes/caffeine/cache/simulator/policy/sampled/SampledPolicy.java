...
public final class SampledPolicy implements KeyOnlyPolicy {
    ...
    public enum Sample {
        ...
        GUESS {
            ...
            @Override
            public <E> List<E> sample(@Nullable E[] elements, E candidate, int sampleSize, Random random, PolicyStats policyStats) {
                throw new UnsupportedOperationException("STUB: not implemented");
            }
        }
        , RESERVOIR {
        ...
        abstract <E> List<E> sample(@Nullable E[] elements, E candidate, int sampleSize, Random random, PolicyStats policyStats);
    }
