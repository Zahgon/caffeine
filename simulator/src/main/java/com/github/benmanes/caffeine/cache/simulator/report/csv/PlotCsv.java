...
public record PlotCsv(Path inputFile, Path outputFile, String metric, String title, ChartStyle style) implements Runnable {
    ...
    private void applyTheme(JFreeChart chart) {
        ...
        theme.setDrawingSupplier(new DefaultDrawingSupplier(getWheelColors(), DEFAULT_FILL_PAINT_SEQUENCE, DEFAULT_OUTLINE_PAINT_SEQUENCE, DEFAULT_STROKE_SEQUENCE, DEFAULT_OUTLINE_STROKE_SEQUENCE, DEFAULT_SHAPE_SEQUENCE));
    ...
    private Color getLineColor(float hue) {
        ...
        return new Color(rgb | a, /* hasalpha= */
        true);
    }
