...
final class BBHeader {
    ...
    abstract static class ReadAndWriteCounterRef extends PadWriteCounter {
        ...
        static final VarHandle READ = findVarHandle(ReadCounterRef.class, "readCounter", long.class);

        static final VarHandle WRITE = findVarHandle(ReadAndWriteCounterRef.class, "writeCounter", long.class);
